...
<section>
	<div id="agileits-sign-in-page" class="sign-in-wrapper">
		<div class="agileinfo_signin">
			<h3>Sign Up</h3>
			<form action="<?php echo base_url();?>index.php/login/register_user" method="post">
				...
				<h6> Already registered Member ? 
					<a class="w3layouts-t" href="<?php echo base_url();?>index.php/login">Sign In</a>
					</h6>
